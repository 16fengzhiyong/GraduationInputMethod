    ...
    companion object {
        ...
        fun builtinDefault(id: String = "default"): SkinPack = SkinPack(
            ...
            colors = mapOf(
                ...
                // ── 键盘专用键 (KeyRenderEngine 消费) ──
                "keyNormalBg" to Color(0xFF2A3545),       // surfaceVariant
                "keyPressedBg" to Color(0xFF0F1923),      // pressedKey
                "keyBorder" to Color(0xFF00D4FF).copy(alpha = 0.30f),
                "keyShadow" to Color.Black.copy(alpha = 0.30f),
                "keyHighlightAlpha" to Color.White.copy(alpha = 0.15f),
                "swipeTrail" to Color(0xFF00D4FF).copy(alpha = 0.60f),
                "swipeUpText" to Color(0xFFF8FAFC).copy(alpha = 0.40f),
                "rootHintText" to Color(0xFF00D4FF).copy(alpha = 0.60f),
                "popupBg" to Color(0xFF00D4FF).copy(alpha = 0.25f),
                "popupText" to Color(0xFFF8FAFC),
                "popupHoverBg" to Color(0xFF00D4FF).copy(alpha = 0.40f),
                "keyNormalGradientTop" to Color(0xFF2A3545),
                "keyNormalGradientBottom" to Color(0xFF1A2332),
                "keyPressedGradientTop" to Color(0xFF1A2332),
                "keyPressedGradientBottom" to Color(0xFF2A3545),
            ),
        ...
        fun builtinNight(id: String = "night"): SkinPack = SkinPack(
            ...
            colors = mapOf(
                ...
                // ── 键盘专用键 ──
                "keyNormalBg" to Color(0xFF2D1B4E),
                "keyPressedBg" to Color(0xFF1A0A2E),
                "keyBorder" to Color(0xFFFF00FF).copy(alpha = 0.60f),
                "keyShadow" to Color.Black.copy(alpha = 0.25f),
                "keyHighlightAlpha" to Color.White.copy(alpha = 0.12f),
                "swipeTrail" to Color(0xFF00FF88).copy(alpha = 0.60f),
                "swipeUpText" to Color(0xFFF8FAFC).copy(alpha = 0.40f),
                "rootHintText" to Color(0xFFFF00FF).copy(alpha = 0.60f),
                "popupBg" to Color(0xFFFF00FF).copy(alpha = 0.25f),
                "popupText" to Color(0xFFF8FAFC),
                "popupHoverBg" to Color(0xFF00FF88).copy(alpha = 0.40f),
                "keyNormalGradientTop" to Color(0xFF2D1B4E),
                "keyNormalGradientBottom" to Color(0xFF1A0A2E),
                "keyPressedGradientTop" to Color(0xFF1A0A2E),
                "keyPressedGradientBottom" to Color(0xFF2D1B4E),
            ),
            typography = ThemeTypography(
                primaryFont = FontFamily.Default,
                keyLabelSize = 20.sp,
        ...
        fun builtinForest(id: String = "forest"): SkinPack = SkinPack(
            ...
            colors = mapOf(
                ...
                // ── 键盘专用键 ──
                "keyNormalBg" to Color(0xFF162038),
                "keyPressedBg" to Color(0xFF0A1628),
                "keyBorder" to Color(0xFF00FFFF).copy(alpha = 0.35f),
                "keyShadow" to Color.Black.copy(alpha = 0.30f),
                "keyHighlightAlpha" to Color.White.copy(alpha = 0.13f),
                "swipeTrail" to Color(0xFF00FFFF).copy(alpha = 0.60f),
                "swipeUpText" to Color(0xFFF8FAFC).copy(alpha = 0.40f),
                "rootHintText" to Color(0xFF00FFFF).copy(alpha = 0.60f),
                "popupBg" to Color(0xFF00FFFF).copy(alpha = 0.25f),
                "popupText" to Color(0xFFF8FAFC),
                "popupHoverBg" to Color(0xFFFF6B35).copy(alpha = 0.40f),
                "keyNormalGradientTop" to Color(0xFF162038),
                "keyNormalGradientBottom" to Color(0xFF0A1628),
                "keyPressedGradientTop" to Color(0xFF0A1628),
                "keyPressedGradientBottom" to Color(0xFF162038),
            ),
            typography = ThemeTypography(
                keyLabelSize = 20.sp,
                fontWeight = FontWeight.Bold
        ...
        fun builtinOcean(id: String = "ocean"): SkinPack = SkinPack(
            ...
            colors = mapOf(
                ...
                // ── 键盘专用键 ──
                "keyNormalBg" to Color(0xFF1A2A3E),
                "keyPressedBg" to Color(0xFF0A1A2E),
                "keyBorder" to Color(0xFF06FFC8).copy(alpha = 0.3f),
                "keyShadow" to Color.Black.copy(alpha = 0.30f),
                "keyHighlightAlpha" to Color.White.copy(alpha = 0.15f),
                "swipeTrail" to Color(0xFF06FFC8).copy(alpha = 0.60f),
                "swipeUpText" to Color(0xFFF8FAFC).copy(alpha = 0.40f),
                "rootHintText" to Color(0xFF06FFC8).copy(alpha = 0.60f),
                "popupBg" to Color(0xFF06FFC8).copy(alpha = 0.25f),
                "popupText" to Color(0xFFF8FAFC),
                "popupHoverBg" to Color(0xFF7C3AED).copy(alpha = 0.40f),
                "keyNormalGradientTop" to Color(0xFF1A2A3E),
                "keyNormalGradientBottom" to Color(0xFF0A1A2E),
                "keyPressedGradientTop" to Color(0xFF0A1A2E),
                "keyPressedGradientBottom" to Color(0xFF1A2A3E),
            ),
        ...
        fun builtinWarmOrange(id: String = "warm_orange"): SkinPack = SkinPack(
            ...
            colors = mapOf(
                ...
                "pressedKey" to Color(0xFF0F1923),
                // ── 键盘专用键 ──
                "keyNormalBg" to Color(0xFF2A3545),
                "keyPressedBg" to Color(0xFF0F1923),
                "keyBorder" to Color(0xFFFF6B35).copy(alpha = 0.30f),
                "keyShadow" to Color.Black.copy(alpha = 0.30f),
                "keyHighlightAlpha" to Color.White.copy(alpha = 0.15f),
                "swipeTrail" to Color(0xFFFF6B35).copy(alpha = 0.60f),
                "swipeUpText" to Color(0xFFF8FAFC).copy(alpha = 0.40f),
                "rootHintText" to Color(0xFFFF6B35).copy(alpha = 0.60f),
                "popupBg" to Color(0xFFFF6B35).copy(alpha = 0.25f),
                "popupText" to Color(0xFFF8FAFC),
                "popupHoverBg" to Color(0xFFFFB74D).copy(alpha = 0.40f),
                "keyNormalGradientTop" to Color(0xFF2A3545),
                "keyNormalGradientBottom" to Color(0xFF1A2332),
                "keyPressedGradientTop" to Color(0xFF1A2332),
                "keyPressedGradientBottom" to Color(0xFF2A3545),
        ...
        fun builtinSakura(id: String = "sakura"): SkinPack = SkinPack(
            ...
            colors = mapOf(
                ...
                // ── 键盘专用键 (亮色主题适配) ──
                "keyNormalBg" to Color(0xFFFFF0F5),
                "keyPressedBg" to Color(0xFFF8BBD0),
                "keyBorder" to Color(0xFFE91E63).copy(alpha = 0.25f),
                "keyShadow" to Color(0xFF880E4F).copy(alpha = 0.12f),
                "keyHighlightAlpha" to Color.White.copy(alpha = 0.20f),
                "swipeTrail" to Color(0xFFE91E63).copy(alpha = 0.50f),
                "swipeUpText" to Color(0xFF1C1B1F).copy(alpha = 0.40f),
                "rootHintText" to Color(0xFFE91E63).copy(alpha = 0.60f),
                "popupBg" to Color(0xFFE91E63).copy(alpha = 0.25f),
                "popupText" to Color(0xFF1C1B1F),
                "popupHoverBg" to Color(0xFFF06292).copy(alpha = 0.40f),
                "keyNormalGradientTop" to Color(0xFFFFF0F5),
                "keyNormalGradientBottom" to Color(0xFFFCE4EC),
                "keyPressedGradientTop" to Color(0xFFFCE4EC),
                "keyPressedGradientBottom" to Color(0xFFFFF0F5),
            ),
            typography = ThemeTypography(keyLabelSize = 20.sp),
            layout = ThemeLayout(keyHeight = 48.dp, cornerRadius = 16.dp),
            animation = ThemeAnimation(),
        ...
        fun deriveFromPrimary(primary: Color, surface: Color = Color(0xFF1A2332)): Map<String, Color> {
            ...
            return mapOf(
                ...
                "pressedKey" to Color(0xFF0F1923),
                // ── 键盘专用键 (自动派生) ──
                "keyNormalBg" to surfaceVariant,
                "keyPressedBg" to Color(0xFF0F1923),
                "keyBorder" to primary.copy(alpha = 0.30f),
                "keyShadow" to Color.Black.copy(alpha = 0.30f),
                "keyHighlightAlpha" to Color.White.copy(alpha = 0.15f),
                "swipeTrail" to primary.copy(alpha = 0.60f),
                "swipeUpText" to Color(0xFFF8FAFC).copy(alpha = 0.40f),
                "rootHintText" to primary.copy(alpha = 0.60f),
                "popupBg" to primary.copy(alpha = 0.25f),
                "popupText" to Color(0xFFF8FAFC),
                "popupHoverBg" to secondary.copy(alpha = 0.40f),
                "keyNormalGradientTop" to surfaceVariant,
                "keyNormalGradientBottom" to surface,
                "keyPressedGradientTop" to surface,
                "keyPressedGradientBottom" to surfaceVariant,
            )
        }
